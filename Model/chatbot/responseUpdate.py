...
def run(landmark):
    ...
    for i in data['intents']:
        if i['tag'] == 'address':
            i['responses'] = ["[" + landmark + "]의 주소는 [" + address + "]입니다. <br> <a href='https://map.naver.com/v5/search/" + address + " " + landmark + "' target='_blank'>여기</a>를 누르시면 상세한 위치를 보실 수 있습니다."]
        if i['tag'] == 'weather':
        ...
        # if i['tag'] == 'restaurant':
        #     i['responses'] = ["[" + landmark + "]주변의 관광명소는 <br> <a href='https://map.naver.com/v5/search/" + place + " 관광지' target='_blank'>여기</a>를 누르시면 지도로 보실 수 있습니다."]
